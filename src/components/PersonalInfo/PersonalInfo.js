...
function PersonalInfo(props) {
    const keys = ["Name", "Professional Headline", "Email", "GitHub", "LinkedIn", "Phone Number", "Location", "Age",]
    const values = ["Stefan Gorgevik", "Full stack web developer",
        "stefangorgevik@hotmail.com", "https://github.com/StefanGorgevik",
        "https://www.linkedin.com/in/stefan-gorgevik-88058918b/", "079-231-692", "Skopje, Macedonia", 25]
